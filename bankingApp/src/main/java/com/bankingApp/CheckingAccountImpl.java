...
public class CheckingAccountImpl implements Account {
	 ...
	 * @param typeAccount
	 */
	public CheckingAccountImpl(double money, double interestRate, int interestPeriod, List<Statement> statementList, String typeAccount) {
		this.money = money;
	...
	public String toString() {
		return "CheckingAccount [money=" + money + ", interestRate=" + interestRate + ", interestPeriod=" + interestPeriod
